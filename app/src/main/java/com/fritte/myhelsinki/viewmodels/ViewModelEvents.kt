...
class ViewModelEvents(repositoryEvents: RepositoryEvents, private val repositoryDirection: RepositoryDirection) : ViewModel() {

    val events = repositoryEvents.getEvents()
